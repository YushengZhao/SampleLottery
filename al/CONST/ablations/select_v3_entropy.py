# al/CONST/ablations/select_v3_entropy.py
import pandas as pd
import numpy as np
...
def main():
    parser = argparse.ArgumentParser(description="Ablation V3: Cluster problems and select the highest-entropy sample from each cluster.")
    ...
    # Select the Highest-Entropy Sample from Each Cluster
    # Sort by cluster, then by entropy in descending order, and pick the first entry for each cluster
    ...
    data_source_name = "CONST_V3_Entropy"
